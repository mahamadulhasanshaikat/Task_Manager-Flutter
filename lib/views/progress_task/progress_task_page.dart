...
class _ProgressTaskPageState extends State<ProgressTaskPage> {
  ...
  // Progress টাস্কের ব্র্যান্ড কালার (Amber/Orange)
  final Color _progressColor = const Color(0xFFF59E0B);
  ...
  Future<void> _fetchProgressTasks() async {
    ...
    final ApiResponse response = await ApiCaller.getRequest(
      url: TMUrls.taskListByStatusUrl('Progress'),
    );
    ...
    if (mounted) {
      if (response.isSuccess && response.responseData['data'] != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(response.responseData['data'] ?? 'Failed to load progress tasks'),
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Move tasks from new to start working.',
                          style: TextStyle(
                            fontSize: 13,
                    ...
                    delegate: SliverChildBuilderDelegate(
                      (context, index) {
                        return TaskCard(
                          ...
                          cardColor: _progressColor,
                          refreshParent: _fetchProgressTasks,
                        );
                      },
